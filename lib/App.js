...
module.exports = class App {
	...
	checkSpeedInput(message) {
		...
		let performanceTimeNeeded = currentEndSpeed - this.currentStartSpeed;
		
		let timeNeeded = message.createdAt.getTime() - this.lastMessageOfBot.createdAt.getTime();

		console.info('Reaction time of user', timeNeeded, '. Reaction time of user calculated by performance.now() is', performanceTimeNeeded);
